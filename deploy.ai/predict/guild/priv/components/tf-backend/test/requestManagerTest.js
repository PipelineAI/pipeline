...
(function (TF) {
    var Backend;
    (function (Backend) {
        var MockedRequestManager = (function (_super) {
            ...
            function MockedRequestManager(maxRequests, maxRetries) {
                ...
                _super.call(this, maxRequests, maxRetries);
                this.resolvers = [];
                this.rejectors = [];
            ...
            MockedRequestManager.prototype._promiseFromUrl = function (url) {
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    var mockFailure = new Backend.RequestNetworkError(mockFailedRequest, url);
                    _this.resolvers.push(function () { resolve(mockJSON); });
                    _this.rejectors.push(function () { reject(mockFailure); });
            ...
            MockedRequestManager.prototype.waitForDispatch = function (num) {
                var _this = this;
                return waitForCondition(function () { return _this.requestsDispatched >= num; });
            };
            return MockedRequestManager;
        }(TF.Backend.RequestManager));
        ...
        describe('backend', function () {
            describe('request manager', function () {
                it('request loads JSON properly', function (done) {
                    ...
                    }, function (reject) { throw new Error(reject); });
                });
                ...
                it('retries at most maxRetries times', function (done) {
                    ...
                    r.then(function (success) { return done(new Error('The reqest should have failed')); }, function (failure) { return done(); });
                });
