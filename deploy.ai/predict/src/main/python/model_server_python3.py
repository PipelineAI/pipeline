...
class Application(tornado.web.Application):
    def __init__(self):
        handlers = [
            ...
            (r'/api/v1/model/deploy/tensorflow/([a-zA-Z\-0-9\.:,_]+)/([a-zA-Z\-0-9\.:,_]+)/([a-zA-Z\-0-9\.:,_]+)',
             ModelDeployTensorFlowHandler),
            # url: /api/v1/model/predict/tensorflow/$PIO_MODEL_NAMESPACE/$PIO_MODEL_NAME/$PIO_MODEL_VERSION/
            (r'/api/v1/model/predict/tensorflow/([a-zA-Z\-0-9\.:,_]+)/([a-zA-Z\-0-9\.:,_]+)/([a-zA-Z\-0-9\.:,_]+)',
             ModelPredictTensorFlowHandler),

            # /deploy is effectively disabled if PIO_MODEL_SERVER_ALLOW_UPLOAD=False
            # url: /api/v1/model/deploy/tensorflow/$PIO_MODEL_STORE_HOME
            (r'/api/v1/model/deploy/tensorflow/([a-zA-Z\-0-9\.:,_]+)',
             ModelDeployTensorFlowHandler),
            # url: /api/v1/model/predict/tensorflow/$PIO_MODEL_STORE_HOME
            ...
            # /deploy is effectively disabled if PIO_MODEL_SERVER_ALLOW_UPLOAD=False
            # url: /api/v1/model/deploy/python3/$PIO_MODEL_STORE_HOME
            (r'/api/v1/model/deploy/python3/([a-zA-Z\-0-9\.:,_]+)',
             ModelDeployPython3Handler),
            # url: /api/v1/model/predict/python3/$PIO_MODEL_STORE_HOME
            ...
            # /deploy is effectively disabled if PIO_MODEL_SERVER_ALLOW_UPLOAD=False
            # url: /api/v1/model/deploy/scikit/$PIO_MODEL_STORE_HOME
            (r'/api/v1/model/deploy/scikit/([a-zA-Z\-0-9\.:,_]+)/([a-zA-Z\-0-9\.:,_]+)/([a-zA-Z\-0-9\.:,_]+)',
             ModelDeployScikitHandler),
            # url: /api/v1/model/predict/scikit/$PIO_MODEL_STORE_HOME
...
class ModelPredictPython3Handler(tornado.web.RequestHandler):
    ...
    def post(self, model_namespace, model_name, model_version):
        ...
        try:
            ...
            message = 'MainHandler.post: Exception - {0} Error {1}'.format('/'.join(model_key_list), str(e))
            LOGGER.info(message)
...
class ModelPredictTensorFlowHandler(tornado.web.RequestHandler):
    ...
    @tornado.web.asynchronous
    def post(self, model_namespace, model_name, model_version):
        model_key_list = ['tensorflow', model_namespace, model_name, model_version]
    ...
    def post(self, model_namespace, model_name, model_version):
        ...
        try:
            ...
            with REQUEST_LATENCY_BUCKETS.labels('deploy', *model_key_list).time():
                ...
                bundle_path = os.path.join(model_base_path, 'tensorflow', model_namespace, model_name, model_version)
                bundle_path_filename = os.path.join(bundle_path, filename)
...
def main():
    try:
        ...
        if not (options.PIO_MODEL_STORE_HOME 
                ...
                #and options.PIO_MODEL_NAMESPACE
                and options.PIO_MODEL_NAME 
                #and options.PIO_MODEL_VERSION 
            ...
            print('--PIO_MODEL_STORE_HOME and --PIO_MODEL_TYPE and --PIO_MODEL_NAME and \
                   ...
                   # and --PIO_MODEL_NAMESPACE
                   # and --PIO_MODEL_VERSION 
            return
