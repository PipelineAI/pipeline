cd $PIPELINE_HOME/package.ml/gpu/cuda8/16.04/ && sudo docker build $2 -q -t fluxcapacitor/package-gpu-cuda8-16.04:$1 .cd $PIPELINE_HOME/package.ml/tensorflow/2a48110-4d0a571/ && sudo docker build $2 -q -t fluxcapacitor/package-tensorflow-2a48110-4d0a571-gpu:$1 -f Dockerfile.gpu .
