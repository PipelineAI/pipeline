...
cd $PIPELINE_HOME/package.ml/tensorflow/7fda1bb-6c096a4/ && pwd && sudo docker build $2 -t fluxcapacitor/package-tensorflow-7fda1bb-6c096a4-gpu:$1 -f Dockerfile.gpu .
cd $PIPELINE_HOME/package.ml/tensorflow/7fda1bb-6c096a4/ && pwd && sudo docker build $2 -t fluxcapacitor/package-tensorflow-7fda1bb-6c096a4-gpu-no-avx:$1 -f Dockerfile.gpu-no-avx .
