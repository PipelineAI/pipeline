...
$SPARK_JOBSERVER_HOME/server_start.sh --packages org.apache.spark:spark-streaming-kafka-assembly_2.10:1.4.1,org.elasticsearch:elasticsearch-spark_2.10:2.1.0,com.datastax.spark:spark-cassandra-connector_2.10:1.4.0,redis.clients:jedis:2.7.3
