...
SPARK_HOME = os.environ.get("SPARK_AVRO_HOME", os.getcwd())
...
GITHUB_BASE = "https://github.com/databricks/spark-avro/pull"
GITHUB_API_BASE = "https://api.github.com/repos/databricks/spark-avro"
