...
### REST API
**Prediction Inputs**:  JSON representation of gray-scale values for **Digit 6**.  ![Digit 6](https://github.com/fluxcapacitor/pipeline/blob/master/predict/samples/tensorflow/mnist/data/6.jpg)
```
