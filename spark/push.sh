...
docker push 954636985443.dkr.ecr.us-west-2.amazonaws.com/pipelineai/spark-gpu:1.5.0
docker push 954636985443.dkr.ecr.us-west-2.amazonaws.com/pipelineai/spark-cpu:1.5.0
...
docker push pipelineai/spark-gpu:1.5.0
docker push pipelineai/spark-cpu:1.5.0
