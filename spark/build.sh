...
docker build -t 954636985443.dkr.ecr.us-west-2.amazonaws.com/pipelineai/spark-gpu:1.5.0 -f Dockerfile.gpu .
docker build -t 954636985443.dkr.ecr.us-west-2.amazonaws.com/pipelineai/spark-cpu:1.5.0 -f Dockerfile.cpu .

docker tag 954636985443.dkr.ecr.us-west-2.amazonaws.com/pipelineai/spark-gpu:1.5.0 pipelineai/spark-gpu:1.5.0
docker tag 954636985443.dkr.ecr.us-west-2.amazonaws.com/pipelineai/spark-cpu:1.5.0 pipelineai/spark-cpu:1.5.0
