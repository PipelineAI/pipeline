...
public class JavaAirbnbTest {
	public static Object predict(Map<String, Object> inputs) {
	...
	@Test
	public void testJavaAirbnbTest() {
		Map<String, Object> inputs = new HashMap<String, Object>();

		inputs.put("bathrooms", 2.0);
		inputs.put("bedrooms", 2.0);
		inputs.put("security_deposit", 175.00);
		inputs.put("cleaning_fee", 25.0);
		inputs.put("extra_people", 1.0);
		inputs.put("number_of_reviews", 2.0);
		inputs.put("square_feet", 250.0);
		inputs.put("review_scores_rating", 2.0);
		inputs.put("room_type", "Entire home/apt");
		inputs.put("host_is_super_host", "0.0");
		inputs.put("cancellation_policy", "flexible");
		inputs.put("instant_bookable", "1.0");
		inputs.put("state", "CA");

		//assertEquals
		System.out.println(predict(inputs));
	}
}