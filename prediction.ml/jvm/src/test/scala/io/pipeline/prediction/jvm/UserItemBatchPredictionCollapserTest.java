  ...
  public void testCollapser() {
    ...
    try {
      // TODO:  use real values here
  	  Future<Object> f1 = new UserItemBatchPredictionCollapser("collapsed_recommendation_user_item_prediction", "my_namespace", "my_version", -1.0d, 100, 10, 10, "21619", "10006").queue();
  	  Future<Object> f2 = new UserItemBatchPredictionCollapser("collapsed_recommendation_user_item_prediction", "my_namespace", "my_version", -1.0d, 100, 10, 10, "21619", "10006").queue();
  	  Future<Object> f3 = new UserItemBatchPredictionCollapser("collapsed_recommendation_user_item_prediction", "my_namespace", "my_version", -1.0d, 100, 10, 10, "21619", "10006").queue();
  	  Future<Object> f4 = new UserItemBatchPredictionCollapser("collapsed_recommendation_user_item_prediction", "my_namespace", "my_version", -1.0d, 100, 10, 10, "21619", "10006").queue();
