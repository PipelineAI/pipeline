...
nohup spark-submit --packages $SPARK_SUBMIT_PACKAGES --class com.advancedspark.spark.streaming.approx.RatingsCountMinSketch $PIPELINE_HOME/myapps/streaming/target/scala-2.10/streaming_2.10-1.0.jar 2>&1 1>$PIPELINE_HOME/logs/streaming/ratings-algebird.log &
