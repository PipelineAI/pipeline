...
nohup python image-classification-service.py > $LOGS_HOME/serving/flask/image-classification-service.log &
echo '...tail -f $LOGS_HOME/serving/flask/image-classification-service.log...' 
