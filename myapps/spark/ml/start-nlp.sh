...
#nohup
spark-submit --jars $SPARK_SUBMIT_JARS,/root/stanford-corenlp-full-2015-12-09/stanford-corenlp-3.6.0-models.jar,/root/stanford-corenlp-full-2015-12-09/stanford-corenlp-3.6.0.jar,/root/stanford-corenlp-full-2015-12-09/jollyday.jar,/root/pipeline/myapps/ml/lib/spark-corenlp_2.10-0.1.jar --packages $SPARK_SUBMIT_PACKAGES --class com.advancedspark.ml.nlp.ItemDescriptionsDF $PIPELINE_HOME/myapps/ml/target/scala-2.10/ml_2.10-1.0.jar 2>&1 1>$PIPELINE_HOME/logs/ml/nlp-item-descriptions-df.log
# &
