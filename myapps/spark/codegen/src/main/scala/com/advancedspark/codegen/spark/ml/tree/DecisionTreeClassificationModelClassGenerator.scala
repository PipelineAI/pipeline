...
//package com.advancedspark.codegen.spark.ml.tree
...
/**
 * DecisionTreeModelClassifier Code Generator
 */
//@Since("Spark1.6.0")
object DecisionTreeModelClassifierModelClassGenerator {
  private val classNamePrefix = "/spark/1.6.0/ml/tree/GeneratedDecisionTreeClassifierModel"
