...
perf stat --repeat 1 --big-num --verbose --scale --event context-switches,L1-dcache-load-misses,L1-dcache-prefetch-misses,LLC-load-misses,LLC-prefetch-misses,stalled-cycles-frontend java -XX:+PreserveFramePointer -XX:-Inline -XX:+CMSClassUnloadingEnabled -XX:ReservedCodeCacheSize=512m -jar ~/sbt/bin/sbt-launch.jar "run-main com.advancedspark.core.thread.LockingTuple2CounterIncrement 25000000 3 2"
