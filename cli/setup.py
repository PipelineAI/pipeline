...
with warnings.catch_warnings():
    setup(
        ...
        package_data={
            ...
            'templates': ['templates/docker/*.template', 'templates/yaml/*.template', 'templates/cluster/yaml/admin/*', 'templates/cluster/yaml/api/*', 'templates/cluster/yaml/dashboard/*', 'templates/cluster/yaml/istio/*', 'templates/cluster/yaml/notebook/*'],
        },
    )
