...
_Copy and Paste [THIS](https://raw.githubusercontent.com/PipelineAI/predict/r1/dashboard/grafana/pipelineai-prediction-dashboard.json) raw json file into the `paste JSON` box_.
